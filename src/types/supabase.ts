...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      atualizar_contas_vencidas: { Args: never; Returns: undefined }
      descontar_credito_funcionario: {
        Args: { id_funcionario: number; valor_desconto: number }
        Returns: undefined
      }
      finalizar_venda: { Args: { id_da_venda: number }; Returns: undefined }
      get_dashboard_stats: {
        Args: never
        Returns: {
      ...
      get_or_create_cliente: { Args: { nome_cliente: string }; Returns: number }
